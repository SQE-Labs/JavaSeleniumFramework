...
public class ScheduleAppointmentTest extends BaseTest {
    ...
    public void fillClientDetails() throws InterruptedException {
        ...
        schedule.enteringClientDetails(CustomerFirstName, CustomerLastName, 2, "11-11-1111",2, "4567892658", EmailAddress, "Math", "NSW", " Tasmania", " Barkers Creek", "South Australia", "5422", "1200", "1000");
    }
