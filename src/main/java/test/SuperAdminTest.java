...
public class SuperAdminTest extends BaseTest {
    ...
    @Test(priority = 0, enabled = false,description = "SuperAdmin is able to create Diagnostician")
    public void create_Diagnostician() throws InterruptedException {
        Diagnostician diagnostician = new Diagnostician();
       String diagnosticianFirstName = "Beau" + RandomStrings.requiredCharacters(2);
        ...
        String diagnosticianUserName = "Riley" + RandomStrings.requiredCharacters(2);
    ...
    diagnostician.create_Diagnostician(diagnosticianFirstName, diagnosticianLastName, "8564234568", diagnosticianEmailAddress, diagnosticianUserName, "123456", "123456");
        ...
        validate_text(actualText,diagnosticianUserName);
    ...
    public void edit_Diagnostician() throws InterruptedException {
        ...
        validate_text(edit_Succ_Msg,"Diagnostician details updated successfully.");
    ...
    public void diagnostician_Relogin() throws InterruptedException {
        ...
        Thread.sleep(10000);
        validate_text(diagnosticianDashBoardPage,"Dashboard");
    }
    ...
    public void diagnostician_login_With_OldPassword() throws InterruptedException {
        ...
        validate_text(validation_Msg,"Username or password is incorrect");
    }
    ...
    public void checking_Toggle_Off() throws InterruptedException {
        ...
        validate_text(disableUser,"Enable User");
    }
    ...
    public void verify_DontSaveBtn() throws InterruptedException {
        ...
        validate_text(UserNameGetText,diagnosticianUserName);
    }
    ...
    public void create_Directors() throws InterruptedException {
        ...
        validate_text(directorListPage,"Directors List");
    }
    ...
    public void edit_Director() throws InterruptedException {
        ...
        validate_text(edit_SuccMsg,"Director details updated successfully.");
    ...
    public void not_Creating_Director() throws InterruptedException {
        ...
        validate_text(UserNameGetText,directorUserName);
    }
    ...
    public void director_Relogin() throws InterruptedException {
        ...
        Thread.sleep(10000);
        validate_text(directorDashBoardPage,"Dashboard");
    }
    ...
    @Test(priority = 0, enabled = true,description = "Verify that SuperAdmin is able to filterthe record or not")
    public void Appointments_Page() throws InterruptedException {
        AppointmentsPage appointment=new AppointmentsPage();
        DiagnosticianTest diagnostian=new DiagnosticianTest();
        LoginPage login =new LoginPage();
        login.validLogin();
