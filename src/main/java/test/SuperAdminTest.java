...
public class SuperAdminTest extends BaseTest {
    ...
    @Test(priority = 0, enabled = false, description = "1.1 Verify that SuperAdmin is able to login")
    ...
    @Test(priority = 1, enabled = false, description = "5.1 Verify that SuperAdmin is able to View AdminList page or not")
    ...
    @Test(priority = 2, enabled = false, description = "5.5, Verify that SuperAdmin is able to create Admin or not")
 ...
 //*************Creating admin by superAdmin************
    ...
    @Test(priority = 3, enabled = false, description = "SuperAdmin is able to search created admin or not")
    ...
    @Test(priority = 7, enabled = false, description = "6 Verify Admin is able to login with new password or not")
    ...
    @Test(priority = 8, enabled = false, description = "5.8 verify that superadmin is able to edit or not after clicking Dont save button")
    ...
    @Test(priority = 9, enabled = false, description = "6.2 Verify that superadmin is not  able create admin with duplicate username or not")
    ...
    @Test(priority = 22, enabled = false, description = "3.19, 3.20 verify that superadmin is able to check toggle button is enable or disable")
