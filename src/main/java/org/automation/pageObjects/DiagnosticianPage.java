...
public class DiagnosticianPage extends BasePage {
    ...
    public By clientDetailText = By.cssSelector("page-header align-items-lg-center");
    ...
    public By upcomingTab=By.xpath("(//li[@class='ng-star-inserted'])[3]");
...
//*****************Set Availability for diagnostician ****************
    ...
    public By slot3 = By.xpath("(//div[@class='mbsc-flex-1-1 mbsc-ios mbsc-ios-dark mbsc-ltr mbsc-timeline-column ng-star-inserted'])[3]");
    public By slot4 = By.xpath("(//div[@class='mbsc-flex-1-1 mbsc-ios mbsc-ios-dark mbsc-ltr mbsc-timeline-column ng-star-inserted'])[4]");
   public By slot5 = By.xpath("(//div[@class='mbsc-flex-1-1 mbsc-ios mbsc-ios-dark mbsc-ltr mbsc-timeline-column ng-star-inserted'])[5]");
    public By slot6 = By.xpath("(//div[@class='mbsc-flex-1-1 mbsc-ios mbsc-ios-dark mbsc-ltr mbsc-timeline-column ng-star-inserted'])[6]");
    public By slot7 = By.xpath("(//div[@class='mbsc-flex-1-1 mbsc-ios mbsc-ios-dark mbsc-ltr mbsc-timeline-column ng-star-inserted'])[7]");
    public By slot8 = By.xpath("(//div[@class='mbsc-flex-1-1 mbsc-ios mbsc-ios-dark mbsc-ltr mbsc-timeline-column ng-star-inserted'])[8]");
    public By slot9 = By.xpath("(//div[@class='mbsc-flex-1-1 mbsc-ios mbsc-ios-dark mbsc-ltr mbsc-timeline-column ng-star-inserted'])[9]");
    public By slot10 = By.xpath("(//div[@class='mbsc-flex-1-1 mbsc-ios mbsc-ios-dark mbsc-ltr mbsc-timeline-column ng-star-inserted'])[10]");
    public By slot11 = By.xpath("(//div[@class='mbsc-flex-1-1 mbsc-ios mbsc-ios-dark mbsc-ltr mbsc-timeline-column ng-star-inserted'])[11]");
    public By slot12 = By.xpath("(//div[@class='mbsc-flex-1-1 mbsc-ios mbsc-ios-dark mbsc-ltr mbsc-timeline-column ng-star-inserted'])[12]");
    public By slot13 = By.xpath("(//div[@class='mbsc-flex-1-1 mbsc-ios mbsc-ios-dark mbsc-ltr mbsc-timeline-column ng-star-inserted'])[13]");
...
//******************Logging as diagnostician************
    ...
    public void click_On_Slot() {
        ...
        // use logic??
    WebdriverWaits.waitUntilVisible(slot5);
        //click_custom(slot3);
       // click_custom(slot4);
        click_custom(slot5);
        click_custom(slot6);
