...
import com.ExtentReports.ExtentReportClass;
...
public class Listeners extends BrowsersInvoked implements ITestListener {
	...
	public void onFinish(ITestContext context) {
		...
		extent.setSystemInfo("Pass Percentage", getPassPercentage(context) + "%");
		extent.flush();
	}
